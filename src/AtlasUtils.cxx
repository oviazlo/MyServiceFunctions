...
void myEditText(Double_t x,Double_t y,Color_t color,Double_t tsize,char *text) {
...
void myBoxText(Double_t x, Double_t y,Double_t boxsize,Double_t tsize,Int_t mcolor,char *text) 
{
